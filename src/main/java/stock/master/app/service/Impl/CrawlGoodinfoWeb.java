...
@Service
public class CrawlGoodinfoWeb extends BaseService {
	 ...
	 * 
	 * */
	public List<Weekly> getinfo (String sid, int count) throws Exception {

		String url = "https://goodinfo.tw/StockInfo/DayTrading.asp?STOCK_ID=2330";
		...
		String[] classList = {"table[class=solid_1_padding_4_2_tbl]"};
